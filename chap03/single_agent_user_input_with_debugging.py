...
# Define a prompt that instructs the assistant agent on query classification
...
# Instantiate the user proxy agent for handling user input
...
# Instantiate the assistant agent with the defined prompt and LLM configuration
assistant = autogen.AssistantAgent(
    name="query_classifier",  # Name of the assistant agent
    system_message=agent_prompt,  # Instruction prompt for query classification
